...
- Public aptitude count is 36,836 questions across 62 subject/subtopic shards.
...
- Public aptitude images are mirrored into `public/images/aptitude/`; current public data references 3,718 local aptitude image files and no remote image URLs.
